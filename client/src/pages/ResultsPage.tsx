...
import type { RoomItem, RoomWithItems, Budget, ProjectBudget } from '../types';
        ...
        <div className="mt-8">
          ...
          <div className="card bg-primary-50 border-2 border-primary-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">
              Save & Send Your {isProjectBudgetType ? 'Project Budget' : 'Estimate'}
            </h2>
            <p className="text-gray-600 mb-6">
              We’ll email your complete {isProjectBudgetType ? 'project budget' : 'furnishings estimate'} and save it to your Reports.
            </p>
            <button
            ...
            >
              {isSaving ? 'Saving…' : 'Save & Send Report →'}
            </button>
          </div>
